# Chapter 114: Attention Visualization для Trading

## Описание

Визуализация attention weights для интерпретации Transformer моделей.
...
1. **Attention is Not Only a Weight: Analyzing Transformers with Vector Norms**
